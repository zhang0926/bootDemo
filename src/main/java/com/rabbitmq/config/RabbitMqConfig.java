...
public class RabbitMqConfig {
    ...
    /** 消息交换机的名字*/
    public static final String EXCHANGE = "firstExchange";

//    /** 队列key1*/
//    public static final String ROUTINGKEY1 = "firstQueue";
//
//    /** 队列key2*/
//    public static final String ROUTINGKEY2 = "secondQueue";
...
//        return BindingBuilder.bind(secondQueue()).to(directExchange()).with(RabbitMqConfig.ROUTINGKEY2);
//    }
